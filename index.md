...
## Getting Started
1. Clone the repo: `git clone git@github.com:NirmalyaASinha/ExpenseAI-docs.git`
...
For more, see the sidebar or visit the [GitHub repo](https://github.com/NirmalyaASinha/ExpenseAI-docs).
